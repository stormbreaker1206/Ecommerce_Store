...
class CartController extends BaseController
{
    ...
    {
        try{
            //creates an array to push the results
            $result = array();
            $cartTotal = 0;
           // $itemIncart = count(Session::get('user_cart'));
            ...
            //store the cart total in a session to charge the customer
    ...
    {
            Cart::clear();
            echo json_encode(['success' => "Your Shopping Cart is Empty!"]);
            exit;
